...
<form method="POST" name="form1" action="Projet.jsp"
    ...
    <div class="flex flex-col">
        ...
        <input readonly type="text" name="ID" value="<jsp:getProperty name='ProjetBean' property='ID'/>"
    ...
    <div class="flex flex-col">
        ...
        <input type="text" name="titre" value="<jsp:getProperty name='ProjetBean' property='titre'/>"
               class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"/>
    </div>

    <div class="flex flex-col">
        <label class="text-gray-700 mb-2">Description :</label>
        <input type="text" name="description" value="<jsp:getProperty name='ProjetBean' property='description'/>"
               class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"/>
    </div>

    <div class="flex flex-col">
        <label class="text-gray-700 mb-2">Objectif financier :</label>
        <input type="number" name="objectif_financier" min="0"
               value="<jsp:getProperty name='ProjetBean' property='objectif_financier'/>"
               class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"/>
    </div>
    ...
    <div class="flex flex-col">
        ...
        <input type="date" name="date_debut" id="date_debut"
               value="<jsp:getProperty name='ProjetBean' property='date_debut'/>"
               class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"/>
    </div>
    ...
    <div class="flex flex-col">
        ...
        <input type="date" name="date_fin" id="date_fin"
               value="<jsp:getProperty name='ProjetBean' property='date_fin'/>"
               class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"/>
    </div>
    ...
    <div class="flex flex-col">
        ...
        <input type="text" name="status_projet" value="<jsp:getProperty name='ProjetBean' property='status_projet'/>"
               class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"/>
    </div>

    <div class="flex flex-col">
        <label class="text-gray-700 mb-2">Porteur :</label>
        <select name="porteur_porteurID"
                class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
...
<script>
    ...
    dateFin.disabled = !dateDebut.value;
