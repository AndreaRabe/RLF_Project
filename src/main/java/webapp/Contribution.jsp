...
<form method="POST" name="form1" action="Contribution.jsp"
    ...
    <div class="flex flex-col">
        ...
        <input type="number" name="montant_contribution" min="0"
               value="<jsp:getProperty name='ContributionBean' property='montant_contribution'/>"
               class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"/>
    </div>
    <div class="flex flex-col">
    ...
    <div class="flex flex-col">
        ...
        <select name="type_contribution"
                class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
            <option value="">-- Type de contribution --</option>
            <option value="don" <%= "don".equals(ContributionBean.getType_contribution()) ? "selected" : "" %>>Don
            </option>
            <option value="financement" <%= "financement".equals(ContributionBean.getType_contribution()) ? "selected" : "" %>>
                Financement
            </option>
        </select>
    </div>
    <div class="flex flex-col">
        ...
        <select name="contributeur_contributeurID"
                class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
...
<script>
    const input = document.getElementById('date_contribution');
    if (!input.value) {
