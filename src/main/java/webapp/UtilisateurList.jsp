...
<html>
<head><title>Listes des Utilisateurs</title>
...
>
	...
	<navbar class="flex justify-center items-center">
		<h1 class="flex m-4 text-4xl text-[#213448] font-bold">Listes des Utilisateurs</h1>
	</navbar>
...
<tbody>
	...
	for(int i = 0; i < utilisateurs.length; i++) {
		...
		out.println("</td>");
		out.print("<td class=\"px-6 py-4\">");
		out.print(utilisateurs[i].getMots_passe());
		out.println("</td>");
		...
		out.print("<a class=\"text-blue-400 text-4\" " + "href=\"Utilisateur.jsp?action=search&ID=");
		out.print(utilisateurs[i].getORMID());
		out.print("\">");
		out.print("Modifier");
		out.print("</a>");
