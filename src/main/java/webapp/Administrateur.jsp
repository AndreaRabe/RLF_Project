...
<form method="POST" name="form1" action=Administrateur.jsp>
	<table>
		...
		<tr>
			<td>Prenom : </td>
			<td><input type=text name="prenom" value="<jsp:getProperty name="AdministrateurBean" property="prenom"/>" /></td>
		</tr>
		<tr>
			<td>Email : </td>
		...
		<tr>
			<td>Mots_passe : </td>
			<td><input type=text name="mots_passe" value="<jsp:getProperty name="AdministrateurBean" property="mots_passe"/>" /></td>
		</tr>
	</table>
