...
<html lang="en">
  <jsp:useBean
    id="AdministrateurBean"
    scope="page"
    class="class_diagram_orm.AdministrateurProcessor"
  />
  ...
  >
    ...
    <nav class="w-full flex justify-center mb-8">
      <h1 class="text-4xl text-[#213448] font-bold">Administrateur</h1>
    </nav>
    ...
    >
      <div>
        ...
        <input readonly type="text" name="ID" value="<jsp:getProperty
          name="AdministrateurBean"
          property="ID"
      ...
      <div class="flex flex-col">
        ...
        <input
          type="text"
          name="nom"
          value="<jsp:getProperty name='AdministrateurBean' property='nom'/>"
      ...
      <div class="flex flex-col">
        ...
        <input
          type="text"
          name="prenom"
          value="<jsp:getProperty name='AdministrateurBean' property='prenom'/>"
          class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
        />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input
          type="text"
          name="email"
          value="<jsp:getProperty name='AdministrateurBean' property='email'/>"
          class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
        />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input
          type="password"
          name="mots_passe"
          value="<jsp:getProperty name='AdministrateurBean' property='mots_passe'/>"
          class="border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
        />
      </div>
