...
<form method="POST" name="form1" action=Utilisateur.jsp>
	<table>
		<tr>
			<td>*ID : </td>
			<td><input type=text name="ID" value="<jsp:getProperty name="UtilisateurBean" property="ID"/>" /></td>
		</tr>
		<tr>
			<td>Nom : </td>
		...
		<tr>
			<td>Mots_passe : </td>
			<td><input type=text name="mots_passe" value="<jsp:getProperty name="UtilisateurBean" property="mots_passe"/>" /></td>
		</tr>
	</table>
